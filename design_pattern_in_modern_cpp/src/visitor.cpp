...
void Fire::accept(Visitor &v) { v.visit(this); }

void Ground::accept(Visitor &v) { v.visit(this); }

void Wind::accept(Visitor &v) { v.visit(this); }

// 3. Create a "visitor" derived class for each "operation" to do on "elements"
class UpVisitor : public Visitor {
  /*virtual*/ void visit(Element *e) {
    cout << "do Up on " + e->info() << '\n';
  }
};

class DownVisitor : public Visitor {
  /*virtual*/ void visit(Element *e) {
    cout << "do Down on " + e->info() << '\n';
  }
};
