...
int main(int argc, char* argv[]) {
  if (argc != 3) {
    std::cerr << "Usage: " << argv[0] << " <can-interface> <master-dcf-path>\n";
    return 1;
  }
  ...
  // Create a CANopen master. The master is asynchronous, which
  ...
  canopen::AsyncMaster master(timer, chan, argv[2], "");
