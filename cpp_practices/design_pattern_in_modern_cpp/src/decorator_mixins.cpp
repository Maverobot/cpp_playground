...
class Point : public Features<Point<Features...>>... {
 public:
  ...
  Point(double x, double y, Features<Point>... features) : Features<Point>(features)... {}
...
int main(int argc, char* argv[]) {
  ...
  Point<Color, Transparancy> colored_transparant_point(1.0, 5.0, {255, 255, 0}, 0.8);
  ...
  std::cout << " colored transparant point: " << colored_transparant_point << std::endl;

  std::cout << " interface added by Color: " << colored_transparant_point.colorInfo() << std::endl;
