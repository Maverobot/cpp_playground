...
int main(int argc, char* argv[]) {
  ...
  std::cout << "std::io_stream::value_type: " << HasTypeT_value_type<std::iostream>::value
            << std::endl;
  std::cout << "std::io_stream::char_type: " << HasTypeT_char_type<std::iostream>::value
            << std::endl;

  std::cout << std::endl;

  // HasMemberT test
  std::cout << "std::vector<double>::size: " << HasMemberT_size<std::vector<double>>::value
            << std::endl;
  ...
  std::cout << "std::vector<double>::begin: " << HasMemberT_begin<std::vector<double>>::value
            << std::endl;
